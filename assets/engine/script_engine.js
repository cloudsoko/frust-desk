...
import { log } from 'frust:plugin/host-api';
...
_trampoline14.fnName = 'wasi:clocks/monotonic-clock@0.2.12#subscribeInstant';
...
_trampoline15.fnName = 'wasi:clocks/monotonic-clock@0.2.12#subscribeDuration';
let exports1;
let memory0;
let realloc0;
let realloc0Async;
...
const _trampoline16 = function(arg0, arg1) {
  ...
  _debugLog('[iface="frust:plugin/host-api", function="log"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  _debugLog('[iface="frust:plugin/host-api", function="log"][Instruction::Return]', {
    funcName: 'log',
    paramCount: 0,
    async: false,
    postReturn: false
...
_trampoline16.fnName = 'frust:plugin/host-api#log';
...
_trampoline17.fnName = 'wasi:random/insecure-seed@0.2.12#insecureSeed';
...
_trampoline18.fnName = 'wasi:io/streams@0.2.12#checkWrite';
...
_trampoline19.fnName = 'wasi:io/streams@0.2.12#write';
...
_trampoline20.fnName = 'wasi:io/streams@0.2.12#blockingFlush';
...
_trampoline21.fnName = 'wasi:cli/environment@0.2.12#getEnvironment';
...
_trampoline22.fnName = 'wasi:cli/terminal-stdin@0.2.12#getTerminalStdin';
...
_trampoline23.fnName = 'wasi:cli/terminal-stdout@0.2.12#getTerminalStdout';
...
_trampoline24.fnName = 'wasi:cli/terminal-stderr@0.2.12#getTerminalStderr';
...
_trampoline25.fnName = 'wasi:clocks/wall-clock@0.2.12#now$1';
let exports2;
let postReturn0;
...
function validate(arg0) {
  ...
  var result9 = realloc0(0, 0, 8, len9 * 24);
  for (let i = 0; i < vec9.length; i++) {
    const e = vec9[i];
    const base = result9 + i * 24;var {key: v0_0, val: v0_1 } = e;
    ...
    switch (variant8.tag) {
      ...
      case 'decimal-v': {
        ...
        dataView(memory0).setUint32(base + 20, len2, true);
        dataView(memory0).setUint32(base + 16, ptr2, true);
        break;
      }
      case 'text-v': {
        const e = variant8.val;
      ...
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant8.tag)}\` (received \`${variant8}\`) specified for \`Value\``);
      }
    }
  }
  _debugLog('[iface="frust:plugin/hooks", function="validate"][Instruction::CallWasm] enter', {
    funcName: 'validate',
    paramCount: 2,
    async: false,
    postReturn: true,
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      var len19 = dataView(memory0).getUint32(ret + 8, true);
      var base19 = dataView(memory0).getUint32(ret + 4, true);
      var result19 = [];
      for (let i = 0; i < len19; i++) {
        const base = base19 + i * 24;
        ...
        switch (dataView(memory0).getUint8(base + 8, true)) {
          ...
          case 5: {
            var ptr13 = dataView(memory0).getUint32(base + 16, true);
            var len13 = dataView(memory0).getUint32(base + 20, true);
          ...
          case 7: {
            var ptr15 = dataView(memory0).getUint32(base + 16, true);
            var len15 = dataView(memory0).getUint32(base + 20, true);
          ...
          case 9: {
            var ptr17 = dataView(memory0).getUint32(base + 16, true);
            var len17 = dataView(memory0).getUint32(base + 20, true);
    ...
    case 1: {
      var ptr20 = dataView(memory0).getUint32(ret + 4, true);
      var len20 = dataView(memory0).getUint32(ret + 8, true);
  ...
  _debugLog('[iface="frust:plugin/hooks", function="validate"][Instruction::Return]', {
    funcName: 'validate',
    paramCount: 1,
    async: false,
    postReturn: true
  });
  const retCopy = variant21;
...
function spin() {
  _debugLog('[iface="frust:plugin/hooks", function="spin"][Instruction::CallWasm] enter', {
    funcName: 'spin',
    paramCount: 0,
    async: false,
    postReturn: false,
  ...
  _debugLog('[iface="frust:plugin/hooks", function="spin"][Instruction::Return]', {
    funcName: 'spin',
    paramCount: 0,
    async: false,
    postReturn: false
...
function hog() {
  _debugLog('[iface="frust:plugin/hooks", function="hog"][Instruction::CallWasm] enter', {
    funcName: 'hog',
    paramCount: 0,
    async: false,
    postReturn: false,
  ...
  _debugLog('[iface="frust:plugin/hooks", function="hog"][Instruction::Return]', {
    funcName: 'hog',
    paramCount: 0,
    async: false,
    postReturn: false
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./script_engine.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABFgRgAn9/AGABfwBgAn9/AGAEf39/fwACQgsAATAAAAABMQABAAEyAAIAATMAAwABNAACAAE1AAEAATYAAQABNwABAAE4AAEAATkAAQAIJGltcG9ydHMBcAEKCgkQAQBBAAsKAAECAwQFBgcICQAvCXByb2R1Y2VycwEMcHJvY2Vzc2VkLWJ5AQ13aXQtY29tcG9uZW50BzAuMjQ2LjI');
    ({ exports: exports0 } = yield instantiateCore(yield module1));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'frust:plugin/host-api': {
        log: exports0['0'],
      },
    ...
    postReturn0 = exports1['cabi_post_frust:plugin/hooks#validate'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_frust:plugin/hooks#validate']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_frust:plugin/hooks#validate'];
    }
    
    hooksValidate = exports1['frust:plugin/hooks#validate'];
    hooksSpin = exports1['frust:plugin/hooks#spin'];
    hooksHog = exports1['frust:plugin/hooks#hog'];
  })();
